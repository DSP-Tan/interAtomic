...
struct bond* makebonds(const char *source, int natoms, double *x_, double *y_, double *z_, int **types, int *type,int num_types, char **namespt ,double cutoff,double *cell,int *NumberOfBonds,struct bond *bondcoeffs, int *NumberOfBondTypes);
struct Angles* makeangles (const char *source,int natoms, double *x_,double *y_,double *z_, char **namespt, double cutoff,double *cell, struct bond *bonds,int NumBonds, int* NumberOfAngles, struct Angles *PosibAngs, int *NumberOfAngleTypes );
